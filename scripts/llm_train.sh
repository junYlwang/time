...
conda activate time
torchrun --nproc_per_node=4 /mnt/shared-storage-user/wangjunyi/time/tools/llm_train.py \
--config /mnt/shared-storage-user/wangjunyi/time/configs/llm-train-no-pad.yaml \
'